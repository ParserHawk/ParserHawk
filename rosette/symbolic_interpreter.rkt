...
;; Ternary match function that takes two lists:
;;  1. patterns - a list of patterns that need to be matched with strings obtained from input-bytestream
;;  2. data-list - a list of strings that need to be matched against the corresponding patterns
...
(define parser%
  (class object%
    ...
    (define/public (step current-header-to-match current-lookup-offset phv updated-bytestream)
