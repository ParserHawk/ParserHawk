...
spec:
Node parse_lisp:
packet.extract(hdr.lisp); --> field0 bit<64>
...
Node parse_inner_ipv4:
packet.extract(hdr.inner_ipv4); --> field1 bit<160>
transition select(hdr.inner_ipv4.version) { [0:4]
    4w0x5: parse_inner_icmp;
    default: accept;
}

Node parse_inner_ipv6:
packet.extract(hdr.inner_ipv6); --> field2 bit<320>
transition select(hdr.inner_ipv6.version) { [0:4]
    4w0x5: parse_inner_icmp;
    default: accept;
}

Node parse_inner_icmp:
packet.extract(hdr.inner_icmp); --> field3 bit<32>
transition accept;

"""

# List the parser's information
input_bit_stream_size = 64 + 320 + 32
pkt_field_size_list = [64, 160, 320, 32]
...
def specification(Input_bitstream, initial_field_val_list):
    ...
    O_field1 = If(Extract(pkt_field_size_list[0] - 1, pkt_field_size_list[0] - 4, O_field0) == BitVecVal(0b0100, 4), 
    ...
    O_field3 = If(And(Extract(pkt_field_size_list[0] - 1, pkt_field_size_list[0] - 4, O_field0) == BitVecVal(0b0100, 4), 
                      Extract(pkt_field_size_list[1] - 1, pkt_field_size_list[1] - 4, O_field1) == BitVecVal(0b0101, 4)),
                  Extract(input_bit_stream_size - pkt_field_size_list[0] - pkt_field_size_list[1] - 1, input_bit_stream_size - pkt_field_size_list[0] - pkt_field_size_list[1] - pkt_field_size_list[3], Input_bitstream), initial_field_val_list[3])
    
    O_field2 = If(Extract(pkt_field_size_list[0] - 1, pkt_field_size_list[0] - 4, O_field0) == BitVecVal(0b0110, 4), 
    ...
    O_field3 = If(And(Extract(pkt_field_size_list[0] - 1, pkt_field_size_list[0] - 4, O_field0) == BitVecVal(0b0110, 4), 
                      Extract(pkt_field_size_list[2] - 1, pkt_field_size_list[2] - 4, O_field2) == BitVecVal(0b0101, 4)),
                  Extract(input_bit_stream_size - pkt_field_size_list[0] - pkt_field_size_list[1] - 1, input_bit_stream_size - pkt_field_size_list[0] - pkt_field_size_list[1] - pkt_field_size_list[3], Input_bitstream), O_field3)
    return [O_field0, O_field1, O_field2, O_field3]
...
def spec(Input_bitstream, initial_list):
    ...
    # 1w0x0, 1w0x0, 1w0x1, 1w0x0, 1w0x0, 3w0x0, 5w0x0, 3w0x0, 16w0x6558
    if Input_bitstream[pkt_field_size_list[0] : pkt_field_size_list[0] + 4] == "0100":
        ...
        if Fields[1][0 : 4] == "0101": # 13w0x0, 4w0x5, 8w0x1
            Fields[3] = Input_bitstream[pkt_field_size_list[0] + pkt_field_size_list[1] : 
                                        pkt_field_size_list[0] + pkt_field_size_list[1] + pkt_field_size_list[3]]
    # 1w0x0, 1w0x0, 1w0x0, 1w0x0, 1w0x0, 3w0x0, 5w0x0, 3w0x0, 16w0x22eb
        ...
        if Fields[2][0 : 4] == "0101":
            Fields[3] = Input_bitstream[pkt_field_size_list[0] + pkt_field_size_list[2] : 
                                        pkt_field_size_list[0] + pkt_field_size_list[2] + pkt_field_size_list[3]]
    l = []
