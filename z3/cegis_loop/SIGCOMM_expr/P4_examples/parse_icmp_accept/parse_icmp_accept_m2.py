...
def specification(Input_bitstream, initial_field_val_list):
    ...
    O_field1 = If(And(Extract(31, 31-3, O_field0) == BitVecVal(0x8, 4), (Extract(31-4, 31-7, O_field0) & BitVecVal(0b1110, 4)) == BitVecVal(0x0, 4)), initial_field_val_list[1], If(Extract(31, 31-3, O_field0) == BitVecVal(0x8, 4), Extract(input_bit_stream_size - 1 - pkt_field_size_list[0], input_bit_stream_size - 1 - pkt_field_size_list[0] - pkt_field_size_list[1] + 1, Input_bitstream), initial_field_val_list[1]))
