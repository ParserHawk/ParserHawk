...
def specification(Input_bitstream, initial_field_val_list):
    ...
    Condition1 = And((Extract(31, 31-7, O_field0) == BitVecVal(0b00000000, 8), Extract(23, 23-3, O_field0) == BitVecVal(0b0000, 4)))
    Condition2 = And((Extract(31, 31-7, O_field0) == BitVecVal(0b00000000, 8), Extract(23, 23-3, O_field0) == BitVecVal(0b0001, 4)))
