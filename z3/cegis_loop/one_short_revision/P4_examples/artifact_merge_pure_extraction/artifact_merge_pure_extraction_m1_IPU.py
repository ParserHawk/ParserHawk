...
input_bit_stream_size = 8*5

pkt_field_size_list = [8, 8, 8, 8, 8]
...
def implementation(Flags, Input_bitstream, idx, pos, random_initial_value_list, 
    ...
    for k in range(5):
        results = []
        for i in range(num_parser_nodes):
            # TODO: Get which pipe this node belongs to parser_node_pipe = [1,1]
            assign_id = 0
            curr_sum = 0
