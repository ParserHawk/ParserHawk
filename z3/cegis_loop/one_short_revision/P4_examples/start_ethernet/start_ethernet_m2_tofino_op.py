...
def specification(Input_bitstream, initial_field_val_list):
    ...
    O_field1 = If((Extract(15, 0, O_field0) & BitVecVal(0b1111101000000000, 16)) == (BitVecVal(0b0000000000000000, 16) & BitVecVal(0b1111101000000000, 16)), Extract(input_bit_stream_size - 1 - pkt_field_size_list[0], input_bit_stream_size - 1 - pkt_field_size_list[0] - pkt_field_size_list[1] + 1, Input_bitstream), initial_field_val_list[1])
