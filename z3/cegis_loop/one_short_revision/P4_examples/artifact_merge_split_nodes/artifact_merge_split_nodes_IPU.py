...
input_bit_stream_size = 32+24

pkt_field_size_list = [32, 24]
...
def specification(Input_bitstream, initial_field_val_list):
    ...
    O_field1 = If(And((Extract(31, 31-7, O_field0) == BitVecVal(0b00000000, 8), Extract(23, 23-3, O_field0) == BitVecVal(0b0000, 4))), Extract(input_bit_stream_size - 1 - pkt_field_size_list[0], input_bit_stream_size - 1 - pkt_field_size_list[0] - pkt_field_size_list[1] + 1, Input_bitstream), initial_field_val_list[1])
    O_field1 = If(And((Extract(31, 31-7, O_field0) == BitVecVal(0b00000000, 8), Extract(23, 23-3, O_field0) == BitVecVal(0b0001, 4))), Extract(input_bit_stream_size - 1 - pkt_field_size_list[0], input_bit_stream_size - 1 - pkt_field_size_list[0] - pkt_field_size_list[1] + 1, Input_bitstream), O_field1)
