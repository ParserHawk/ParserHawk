...
def specification(Input_bitstream, initial_field_val_list):
    ...
    Condition = And((Extract(pkt_field_size_list[0] - 1, pkt_field_size_list[0] - 1 -7, O_field0) == BitVecVal(0b00000000, 8), Extract(pkt_field_size_list[0] - 1 - 8, pkt_field_size_list[0] - 1 - 8 - 2, O_field0) == BitVecVal(0b000, 3)))
    O_field1 = If(Condition, Extract(input_bit_stream_size - 1 - pkt_field_size_list[0], input_bit_stream_size - 1 - pkt_field_size_list[0] - pkt_field_size_list[1] + 1, Input_bitstream), initial_field_val_list[1])
