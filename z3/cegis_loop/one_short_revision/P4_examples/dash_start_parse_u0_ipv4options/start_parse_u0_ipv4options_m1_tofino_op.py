...
parser ParserI(packet_in b,
    ...
    state start {
        packet.extract(hd.u0_ipv4);  // 4-bit
...
def specification(Input_bitstream, initial_field_val_list):
    ...
    Cond_field1 = Extract(pkt_field_size_list[0] - 1, 0, O_field0) == BitVecVal(0x5, pkt_field_size_list[0])
...
def spec(Input_bitstream, initial_list):
    ...
    if int(Fields[0][0 : pkt_field_size_list[0]], 2) == 0x5:
...
def synthesis_step(cexamples):
    ...
    #     s.add(key_val_total_list[i] == 0x5)
    for i in range(tcam_num):
        s.add(Or(key_val_total_list[i] == 0x0, key_val_total_list[i] == 0x1, key_val_total_list[i] == 0x2,
                 key_val_total_list[i] == 0x3, key_val_total_list[i] == 0x4, key_val_total_list[i] == 0x5,
                 key_val_total_list[i] == 0x6, key_val_total_list[i] == 0x7, key_val_total_list[i] == 0x8,
                 key_val_total_list[i] == 0x9, key_val_total_list[i] == 0xa, key_val_total_list[i] == 0xb,
                 key_val_total_list[i] == 0xc, key_val_total_list[i] == 0xd, key_val_total_list[i] == 0xe,
                 key_val_total_list[i] == 0xf))
    for i in range(tcam_num):   
