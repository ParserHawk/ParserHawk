...
def specification(Input_bitstream, initial_field_val_list):
    ...
    Cond = (O_field0 == BitVecVal(0x1, 4)) or (O_field0 == BitVecVal(0x2, 4)) or (O_field0 == BitVecVal(0x4, 4)) or (O_field0 == BitVecVal(0x5, 4)) or (O_field0 == BitVecVal(0x6, 4)) or (O_field0 == BitVecVal(0x7, 4))
...
def spec(Input_bitstream, initial_list):
    ...
    if int(Fields[0], 2) == 1 or int(Fields[0], 2) == 2 or int(Fields[0], 2) == 4 or int(Fields[0], 2) == 5 or int(Fields[0], 2) == 6 or int(Fields[0], 2) == 7:
...
def synthesis_step(cexamples):
    ...
    for i in range(tcam_num):
        s.add(Or(key_val_total_list[i] == 0x1, key_val_total_list[i] == 0x2,
                 key_val_total_list[i] == 0x4, key_val_total_list[i] == 0x5,
                 key_val_total_list[i] == 0x6, key_val_total_list[i] == 0x7))
