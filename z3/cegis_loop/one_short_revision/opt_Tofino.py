...
input_bit_stream_size = 12
num_pkt_fields = 3
pkt_field_size_list = [6, 4, 6]
...
def synthesis_step(cexamples):
    ...
    if not cexamples:
        ...
        for j in range(len(cexamples)):
            ...
            spec_out = spec(format(Input_bitval, '012b'), random_initial_value_list)
