...
def specification(Input_bitstream, initial_field_val_list):
    ...
    O_field1 = If(Or(Extract(15, 0, O_field0) == BitVecVal(0xF, 16), Extract(15, 0, O_field0) == BitVecVal(0x0, 16)), Update_V, initial_field_val_list[1])
...
def spec(Input_bitstream, initial_list):
    ...
    if int(Fields[0][0 : 15], 2) == 0 or int(Fields[0][0 : 15], 2) == 15:
